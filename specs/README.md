...
Status: discovery. Path of Flipper will help Path of Exile 1 players discover currency-flipping opportunities on the in-game currency exchange, ranked by expected profit over time. The core idea is captured; detailed requirements remain open.

All project specifications live in this directory. Start with [Project brief](./project-brief.md).
